...
public class RenameModifier : Machine, ISerializable<RenameModifier>
{
    ...
    public override void Process(File file)
    {
        ...
        var newName = string.Format(OutputFormat, match.Groups);
    ...
    {
        var inputFormat = json["input_format"]?.GetValue<string>();
        var outputFormat = json["output_format"]?.GetValue<string>();
